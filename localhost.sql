...
--
CREATE DATABASE IF NOT EXISTS `BakeItHappen` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `BakeItHappen`;
...
('root', '[{\"db\":\"BakeItHappen\",\"table\":\"Users\"},{\"db\":\"project\",\"table\":\"users\"}]');
...
('root', '2020-11-18 22:12:09', '{\"Console\\/Mode\":\"collapse\"}');
